#!/bin/sh
# Host unit tests for device_settings (mocked NVS).
set -e
...
# Create mock nvs_flash.h for host testing
...
# Create mock nvs_flash.c for host testing
...
# Create mock nvs.h for host testing
...
# Create mock esp_log.h for host testing
...
cc -std=c11 -Wall -Wextra -Werror -O2 \
   ...
   "$DIR/test_device_settings.c" \
   -o "$OUT/test_device_settings"

"$OUT/test_device_settings"