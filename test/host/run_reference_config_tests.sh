...
cc -std=c11 -Wall -Wextra -Werror -O2 \
   ...
   -I"$DIR/../../devices/reference_device/main" \
   "$OUT/mock_nvs.c" \
   ...
   "$DIR/../../devices/reference_device/main/reference_config.c" \
   "$DIR/test_reference_config.c" \
   -o "$OUT/test_reference_config"

"$OUT/test_reference_config"
